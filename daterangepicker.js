...
(function (root, factory) {
  ...
  var DateRangePicker = function(element, options, cb) {
      ...
      // autoApply: Hide the apply and cancel buttons, and automatically apply a new date range as soon as two dates are clicked.
      if (this.autoApply) {
      ...
      // https://jietu.qq.com/upload/index.html?image=http://jietu-10024907.file.myqcloud.com/bpbfhnvpikooyqjcduspfjlarzoqnsjh.jpg
      if (typeof options.ranges === 'object')
      ...
      // alwaysShowCalendars: Normally, if you use the ranges option to specify pre-defined date ranges,
      ...
      if ((typeof options.ranges === 'undefined' && !this.singleDatePicker) || this.alwaysShowCalendars) {
          // 设置 calendar、buttons(cancel、apply) display: block，但是该样式优先级要低于 auto-apply 的display:none;
